...
class PreferencesTestdrivegtkDialog(gtk.Dialog):
    ...
    def __init__(self):
        ...
        Creation of a PreferencesTestdrivegtkDialog requires redeading the associated ui
        file and parsing the ui definition extrenally,
        and then calling PreferencesTestdrivegtkDialog.finish_initializing().

        Use the convenience function NewPreferencesTestdrivegtkDialog to create
    ...
    def get_preferences(self):
        ...
        preferences for testdrivegtk. Creates a couchdb record if
        necessary.
        """
...
def NewPreferencesTestdrivegtkDialog():
    """NewPreferencesTestdrivegtkDialog - returns a fully instantiated
    PreferencesTestdrivegtkDialog object. Use this function rather than
    creating a PreferencesTestdrivegtkDialog instance directly.
    """

    #look for the ui file that describes the ui
    ui_filename = os.path.join(getdatapath(), 'ui', 'PreferencesTestdrivegtkDialog.ui')
    if not os.path.exists(ui_filename):
        ui_filename = None

    builder = gtk.Builder()
    builder.add_from_file(ui_filename)
    dialog = builder.get_object("preferences_testdrivegtk_dialog")
    dialog.finish_initializing(builder)
    return dialog

if __name__ == "__main__":
    dialog = NewPreferencesTestdrivegtkDialog()
    dialog.show()
    gtk.main()
